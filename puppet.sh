...
wget http://www.cs.duke.edu/~maxdml/experiments-setter/master-node.pp &>> /local/init.log
wget http://www.cs.duke.edu/~maxdml/experiments-setter/spark.pp &>> /local/init.log
puppet apply master-node.pp  &>> /local/init.log
puppet apply spark.pp  &>> /local/init.log
